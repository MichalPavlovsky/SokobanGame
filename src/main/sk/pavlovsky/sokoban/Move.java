...
//        } else if (map[manPos1][manPos2+1] instanceof Wall){
//            System.out.println("you cannot move, before you is wall");
//        } else if (map[manPos1][manPos2+1] instanceof LevelObject.Box && map[manPos1][manPos2+1] instanceof Wall) {
...
//        } else if (map[manPos1-1][manPos2] instanceof Wall){
//            System.out.println("you cannot move, before you is wall");
...
//        } else if (map[manPos1+1][manPos2] instanceof Wall){
//            System.out.println("you cannot move, before you is wall");
//        } else if (map[manPos1+1][manPos2] instanceof LevelObject.Box && map[manPos1+1][manPos2] instanceof Wall) {
//            System.out.println("you cannot move, wall is after box");
//}
//    }
//}
